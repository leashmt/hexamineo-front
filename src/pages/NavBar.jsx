            ...
            <header className="py-4 shadow-lg relative">
                ...
                <div
                    className={`lg:hidden absolute top-full left-0 right-0 bg-white-background shadow-md transition-all duration-300 ease-in-out w-full ${
                        isOpen
                            ? 'max-h-100 opacity-100 pointer-events-auto'
                            ...
                            {user ? (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="block w-full text-left py-2 px-4 hover:bg-red-500 hover:text-white rounded-md transition duration-200 text-center"
                                    >
                                        Déconnexion
                                    </button>
                                </>
