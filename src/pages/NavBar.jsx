  ...
  return (
    <div className="bg-white-background min-h-screen flex flex-col">
      <header className="py-4 shadow-lg">
        <nav className="flex justify-center space-x-6 text-lg">
          <div className = "flex space-x-8">   
            ...
            <Link to="/professorDistribution" className="hover:text-yellow-highlight">Répartition des professeurs</Link>
      ...
      <div className="w-full">
        <img src={footerImage} alt="Silhouette du petit prince" className="w-full object-cover"/>
      </div>
