  ...
  return (
    <div class="flex flex-col items-center justify-center pt-[50px]">
      ...
      <h2 className="text-2xl font-bold mb-6 text-purple-custom text-center">
        ...
        <div className="mb-4">
          <label htmlFor="nom" className="block text-purple-custom text-sm font-bold mb-2">Prénom :</label>
          <input
            type="text"
            id="prenom"
            name="prenom"
        ...
        <div className="mb-4">
          <label htmlFor="nom" className="block text-purple-custom text-sm font-bold mb-2">Classe :</label>
          <input
            type="text"
            id="classe"
            name="classe"
        ...
        <div className="mb-6">
          <label htmlFor="nom" className="block text-purple-custom text-sm font-bold mb-2">Email :</label>
          <input
            type="text"
            id="email"
            name="email"
